 ...
 * as SpringSocialSecurityProfile instances within the ConnectionRepository
 * itself
 * 
 * By providing this entity we enable custom local user details to be stored and
 * initialised on signup as User instances.
 * 
